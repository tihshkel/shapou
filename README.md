...
*Интерактивная игра-симулятор виртуального питомца с мини-играми, системой одежды и отслеживанием состояния*
...
- **Гардеробная** — комната для выбора и надевания одежды (шляпа, очки)
- **Улица** — прогулка на свежем воздухе с доступом к огороду
- **Огород** — специальная локация с сюжетными элементами
...
### 👕 Система одежды
- **Выбор одежды** — надевайте на питомца шляпу или очки
- **Влияние на эмоции** — одежда повышает настроение питомца
...
│
├── 📱 ShaPou/
│   ├── ContentView.swift          # Основной экран приложения, логика игры, мини-игры и UI
│   ├── ShaPouApp.swift            # Точка входа приложения (@main)
│   │
│   ├── 🎨 Assets.xcassets/        # Ресурсы приложения
│   │   ├── AppIcon.appiconset/    # Иконки приложения
│   │   ├── *.imageset/            # Изображения и спрайты (персонажи, кнопки, фоны)
│   │   └── AccentColor.colorset/  # Цветовая схема
│   │
│   ├── 🖼️ Images/                  # Дополнительные изображения
│   │   └── *.png, *.jpg           # Графические ресурсы (фоны комнат, персонажи, UI элементы)
│   │
│   └── 🔊 Sounds/                  # Аудио файлы
...
1. **Главное меню**
   ...
   - Используйте "Настройки" для настройки приложения (в разработке)
...
2. **Игровой процесс**
   ...
   - **Одежда**: перейдите в гардеробную, нажмите "Одевать" и выберите шляпу или очки стрелками
...
- Одежда повышает эмоции (+10% за выбор)
